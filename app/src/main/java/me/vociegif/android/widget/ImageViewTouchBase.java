...
import me.vociegif.android.widget.easing.Cubic;
import me.vociegif.android.widget.easing.Easing;
...
public abstract class ImageViewTouchBase extends ImageView implements IDisposable {
	...
	public ImageViewTouchBase(Context context) {
		this(context, null);
		// 防止在android4.0.3及其以下(其实是4.1版本 以下)，drawTextOnPath是无效的
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		// ", bitmapChanged: " + mBitmapChanged + ", scaleChanged: " +
		// mScaleTypeChanged);
		// System.out.println("==========>onLayout "+changed+"
	...
	public void resetMatrix() {
		...
		if (LOG_ENABLED) {
			// log.d(LOG_TAG, "default scale: " + scale + ", scale: " +
			// getScale());
		}
	...
	public void setImageBitmap(final Bitmap bitmap, Matrix matrix, float min_zoom, float max_zoom) {
		// System.out.println("setImageBitmap=========> "+bitmap.getWidth()+"
		// "+bitmap.getHeight());
		if (bitmap != null)
