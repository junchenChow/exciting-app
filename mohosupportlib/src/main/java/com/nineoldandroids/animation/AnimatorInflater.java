...
public class AnimatorInflater {
    ...
    private static ValueAnimator loadAnimator(Context context, AttributeSet attrs, ValueAnimator anim)
        ...
        TypedArray a =
                context.obtainStyledAttributes(attrs, /*com.android.internal.R.styleable.*/AnimatorInflater.Animator);

        long duration = a.getInt(/*com.android.internal.R.styleable.*/AnimatorInflater.Animator_duration, 0);

        long startDelay = a.getInt(/*com.android.internal.R.styleable.*/AnimatorInflater.Animator_startOffset, 0);

        int valueType = a.getInt(/*com.android.internal.R.styleable.*/AnimatorInflater.Animator_valueType,
                VALUE_TYPE_FLOAT);
        ...
        if (a.hasValue(/*com.android.internal.R.styleable.*/AnimatorInflater.Animator_repeatCount)) {
            anim.setRepeatCount(
                    a.getInt(/*com.android.internal.R.styleable.*/AnimatorInflater.Animator_repeatCount, 0));
        }
        if (a.hasValue(/*com.android.internal.R.styleable.*/AnimatorInflater.Animator_repeatMode)) {
            anim.setRepeatMode(
                    a.getInt(/*com.android.internal.R.styleable.*/AnimatorInflater.Animator_repeatMode,
