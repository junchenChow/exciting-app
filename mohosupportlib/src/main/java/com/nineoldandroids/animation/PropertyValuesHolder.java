...
public class PropertyValuesHolder implements Cloneable {
     ...
     */
    public static PropertyValuesHolder ofKeyframe(android.util.Property<View, Float> scaleX, Keyframe... values) {
        KeyframeSet keyframeSet = KeyframeSet.ofKeyframe(values);
        if (keyframeSet instanceof IntKeyframeSet) {
            return new IntPropertyValuesHolder("", (IntKeyframeSet) keyframeSet);
        } else if (keyframeSet instanceof FloatKeyframeSet) {
            return new FloatPropertyValuesHolder("", (FloatKeyframeSet) keyframeSet);
        }
        else {
